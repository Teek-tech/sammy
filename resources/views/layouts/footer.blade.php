        ...
        <div class="col-sm-12 col-md">
          <div class="ftco-footer-widget mb-4 ml-md-4">
            ...
            <ul class="list-unstyled">
              <li><a href="about">LinkedIn: www.linkedin.com/in/sammybadaki</a></li>
              <li><a href="contact">Twitter: @sammybadaki</a></li>
              <li><a href="services">Facebook: www.facebook.com/sammybadaki</a></li>
              <li><a href="services">Instagram: @sammybadaki</a></li>
            </ul>
          </div>
        </div>
          ...
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">letstalk@sammybadaki.online</span></a></li>
                </ul>
              </div>
          </div>
        </div>
